        ...
        <div class="modal-content border-0">
            ...
            <div class="modal-body">
                ...
                <div class="form-row col-md-12 form-group">
                    ...
                    <span class="input-wrapper">
                        <input type="text" name="post_code" class="input-text form-control @error('post_code') is-invalid @enderror" value={{$v['post_code']}}>
                    </span>
                </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary primaryAddrSubmit" data-dismiss="modal">Submit Changes</button>
              </div>
        </div>
    </div>
</div>
