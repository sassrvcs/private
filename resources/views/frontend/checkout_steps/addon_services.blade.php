                              ...
                              @foreach($addonServices as $key => $addonService)   
                                 <div class="row align-items-center mb-3 pb-2 addons">
                                    ...
                                    <div class="col-md-2 col-6 text-md-end">
                                       <a href="javascript:void(0);" class="btn btn-primary btn-sm addserv" data-item="{{ $addonService->id }}">Add</a>
                                    </div>
                                 </div>
                              @endforeach
                           </div>
...
@section('script')
   <script>
      ...
      //    // Get the "Add" button with the class "addserv"
      //    const addButton = document.querySelector(".addserv");
      ...
      //    //    // Now you have the ID of the clicked item and can perform any action you need based on it.
      //    //    // ...
      //    // });
      ...
      document.addEventListener("DOMContentLoaded", function() {
         ...
         addButtons.forEach(function(button) {
            button.addEventListener("click", function() {
                  ...
                  // Now you have the ID of the clicked item and can perform any action you need based on it.
                  // For example, you can use this ID to fetch additional data or add the item to your cart.
            });
         });
      });
