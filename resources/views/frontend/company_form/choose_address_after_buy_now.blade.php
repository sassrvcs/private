                                    ...
                                    <div class="office-address ">
                                        <div class="top-block">
                                            ...
                                            <div class="price-block">
                                                ...
                                                <input type="hidden" value="{{$purchase_address->price}}" id="registered_office_price">
                                            </div>
                                        </div>
                                        <div class="desc">
                                            <div class="tham-img">
                                        ...
                                        <div class="btn-block">
                                            ...
                                            <button class="btn buy-now-btn @if ((stripos($package_type, 'Residents') !== false) || stripos($package_type, 'Eseller') !== false) d-none @endif" onclick="gotoPage()">Remove</button>
                                        </div>
        ...
        function selectedForwardAdd(order_id,addressId) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    address_price:{{$purchase_address->price}}
                },
                success: function(result) {
                    console.log(result);
                    setTimeout(function() {
