                    ...
                    <div class="top-step-items">
                        ...
                        <span>Delivery & Partner Details</span>
                            ...
                            <div class="form-wrap person_section d-none">
                                                ...
                                                <div class="choose-possition-block">
                                                    ...
                                                    <div class="choose-possition-option">
                                                        ...
                                                        <li class="{{$company_type == 'Limited Liability Partnership' ? '' : 'd-none'}}">
                                                            ...
                                                            <input type="checkbox" class="checkBoxPos"
                                                            value="Member" id="member_checkbox" onclick="llpConsent(),toggleCorporateDetails()">
                                                        ...
                                                        <li class="{{$company_type == 'Limited Liability Partnership' ? '' : 'd-none'}}">
                                                            ...
                                                            <input type="checkbox" class="checkBoxPos"
                                                            value="Designated Member"  id="designated_checkbox" onclick="designatedTab(),llpConsent(),toggleCorporateDetails()" @if (isset($_COOKIE['llp_designated_check'.$_GET['order']]) && $_COOKIE['llp_designated_check'.$_GET['order']] == 'true')
                                                            checked  @endif>
                                                        ...
                                                        <div class="col-md-6 col-sm-12 corporate_details_expect_legal_container">
                                                            ...
                                                            <div class="form-group place_registered_div d-none">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    id="place_registered" name="place_registered" value="United Kingdom">

                                                            </div>
                                                            <div class="form-group registry_held_div d-none">
                                                                <label for="">Registry Held</label>
                                                                <input type="text" class="form-control"
                                                                    id="registry_held" name="registry_held" value="Companies House">
                                                            </div>
                                                            <div class="form-group law_governed_div d-none">
                                                                <label for="">Law Governed</label>
                                                                <input type="text" class="form-control"
                                                                    id="law_governed" name="law_governed" value="Companies Act 2006">
                                ...
                                <div class="step-btn-wrap mt-4">
                                    {{-- <button class="btn prev-btn" id="cancelBtn" onclick="location.reload()">Cancel</button> --}}
...
@section('script')
    <script>
        ...
        function toggleCorporateDetails() {
            ...
            if(!$('#psc').is(":checked")){
            if (($('#director').is(":checked") || $('#secretary').is(":checked") || $("#member_checkbox").is(":checked")||$("#designated_checkbox").is(":checked")||$("#guarantor_checkbox").is(":checked"))&& !$('#psc').is(":checked")) {
