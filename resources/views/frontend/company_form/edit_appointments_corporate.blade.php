                                                    ...
                                                    <div class="choose-possition-option">
                                                        <ul>
                                                            ...
                                                            <li class="{{$company_type == 'Limited Liability Partnership' ? '' : 'd-none'}}">
                                                                ...
                                                                <input type="checkbox" class="checkBoxPos"
                                                                value="Member" id="member_checkbox" onclick="llpConsent(),toggleCorporateDetails()" @if (in_array("Member", $positions))checked
                                                                @endif>
                                                            ...
                                                            <li class="{{$company_type == 'Limited Liability Partnership' ? '' : 'd-none'}}">
                                                                {{-- @if (isset($_COOKIE['llp_designated_check'.$_GET['order']]) && $_COOKIE['llp_designated_check'.$_GET['order']] == 'true')
                                                                checked  @endif --}}
                                                                <input type="checkbox" class="checkBoxPos"
                                                                value="Designated Member"  id="designated_checkbox" onclick="designatedTab(),llpConsent(),toggleCorporateDetails()"  @if (in_array("Designated Member", $positions))checked
                                                                @endif>
...
@section('script')
    <script>
        ...
        function toggleCorporateDetails() {
            ...
            if(!$('#psc').is(":checked")){
            if (($('#director').is(":checked") || $('#secretary').is(":checked")|| $("#member_checkbox").is(":checked")||$("#designated_checkbox").is(":checked"))&& !$('#psc').is(":checked")) {
