                            ...
                            <div class="form-wrap">
                                <div class="form-info-block">
                                    ...
                                    <form id="company-document" action="{{ route('companyname.document') }}" method="post">
                                            ...
                                            <div class="form-info-block">
                                                ...
                                                <div class="document-list-wrap">
                                                    <div class="document-list">
                                                        ...
                                                        <input type="hidden" name="other_legal_document" id="other_legal_document" value="{{ (empty($other_legal_Document) || $other_legal_Document == 'green') ? 'green' : 'standard' }}">
                                                        <div class="box text-right">
                                                            <div class="switch-slider-wrap">
                                                                <label class="toggleSwitch large" onclick="">
                                                                    <input type="checkbox" name="green" value="green" id="green" {{ (empty($other_legal_Document)) ? 'checked' : '' }} {{ (!empty($other_legal_Document) && $other_legal_Document == 'green') ? 'checked' : '' }} />
                                                                    <span>
                                                                        <span>Select</span>
                                                                        <span>Select</span>
                                                                    </span>
                                                    ...
                                                    <div class="document-list">
                                                        ...
                                                        <div class="box text-right">
                                                            <div class="switch-slider-wrap">
                                                                <label class="toggleSwitch large" onclick="">
                                                                    <input type="checkbox" name="standard" value="standard" id="standard" {{ (!empty($other_legal_Document) && $other_legal_Document == 'standard') ? 'checked' : '' }}  />
                                                                    <span>
                                                                        <span>Select</span>
                                                                        <span>Select</span>
                                                                    </span>
                                        ...
                                        <div class="docu-info">
                                            <p>
                                                The articles of association is a document which, along with the memorandum of association forms the company’s constitution, defines the responsibilities of the directors, the kind of business to be undertaken, and the means by which the shareholders exert control over the board of directors.
                                            </p>
                                        </div>
