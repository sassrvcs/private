                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="used-addresses-panel">
                                            ...
                                            <div class="btn-wrap">
                                                ...
                                                <input type="hidden" class="user_id" name="user_id" value="{{ $value->user_id}}">
                                                <input type="hidden" class="address_id" name="address_id" value="{{ $value->id}}" data-address="{{$value->id}}">
