                        ...
                        <div class="particulars-form-wrap">
                            ...
                            <div class="particulars-bottom-step">
                                ...
                                @if ($particular_step)
                                    <div class="bottom-step-items active">
                                        ...
                                        <p>
                                            <a href="{{ route('companie-formation', ['order' => $_GET['order'] ?? '', 'section' => 'Company_formaction', 'step' => 'register-address']) }}"
                            ...
                            @php
                                ...
                                if (stripos($package_type, 'Guarantee') !== false) {
                                    $raw_pkg_type = 'Guarantee';
                                }
                                if (stripos($package_type, 'Residents') !== false) {
                                    $raw_pkg_type = 'Residents';
                                }
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <span class="nb-text">Your requested company name is displayed below.
                                                        If you wish to change this, insert another name and click.</span>
                                                    <div class="check-another-name">
                                                        ...
                                                        <input type="text" class="form-control" name="companie_name"
                                                            id="companie_name"
                                                            value="{{ old('companie_name', strtoupper($companyFormationStep->companie_name ?? ($orders->company_name ?? ''))) }}"
                                                            oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);">
                                                        <button type="submit" class="btn check-company">Check another
                                                            name</button>
                                                    </div>
                                                </div>

                                                <div class="text-danger alert-custom-highlight-s1" id="srchfld-error"
                                                    style="display: none">
                                                    <em id="srchfld-error" class="text-danger">
                                                        <h4 id="message-cls">Warning, <span class="companie-name"> </span>
                                                            is <span id="c-availablity"></span> available for registration.
                                                        </h4>
                                                        @if (stripos($raw_pkg_type, 'PLC') !== false)
                                                ...
                                                <div class="text-danger alert-custom-highlight-s1" id="srchfld-success"
                                                    style="display: none">
                                                    <em id="srchfld-success" class="text-danger">
                                                        <h4 id="message-cls"><span class="companie-name"> </span> <span
                                                                style="color: #3B9D22 !important">is available for
                                                ...
                                                <div class="sensitive-word-chk" style="display: none">
                                                    ...
                                                    <div class="w-row ef-supporting-doc-attachment-wrapper"
                                                        style="clear:both">
                                                        <h4>Supporting Document</h4>
                                                        <div class="w-col w-col-8">
                                                            <div>
                                                                <input class="w-input file-upload" type="file"
                                                                    name="file-upload-sensitive"
                                                                    id="file-upload-sensitive" accept="application/pdf">
                                                                <button type="button"
                                                                ...
                                                                @else
                                                                    <input type="hidden" name="sesitive_documents"
                                                                        id="sesitive-documents" value="false">
                                                                @endif
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="same-as-name-word" style="display: none">
                                                    ...
                                                    <div class="sensitive-guidance">
                                                        <div class="sensitive-word">
                                                            <p> You need permission from <strong
                                                                    class="company-name"></strong> to use this company
                                                                name.</p>
                                                            <p> Please obtain permission and upload file here.</p>
                                                        </div>
                                                    </div>
                                                    <input type="hidden" name="same_as_name" id='same_as_name'
                                                        value="">
                                                    <div class="w-row ef-supporting-doc-attachment-wrapper"
                                                        style="clear:both">
                                                        <h4>Supporting Document</h4>
                                                        <div class="w-col w-col-8">
                                                            <div>
                                                                <input class="w-input file-upload" type="file"
                                                                    name="file-upload-same-as-name"
                                                                    id="file-upload-same-as-name"
                                                                ...
                                                                @else
                                                                    <input type="hidden" name="same_as_name_documents"
                                                                        id="same-as-name-documents" value="false">
                                                                @endif
                                                            </div>
                                                        </div>
                                                        <div class="w-col w-col-12 sensitive-col ef-upload-result"> </div>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="companie_type">
                                                        ...
                                                        @endif
                                                        @if (stripos($raw_pkg_type, 'Guarantee') !== false)
                                                            <option value="Limited By Guarantee">Limited By Guarantee
                                                            </option>
                                                        @endif
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <select
                                                        class="form-control @error('jurisdiction_id') is-invalid @enderror"
                                                        name="jurisdiction_id">
                                                        <option value="">Select one</option>
                                                        @foreach ($jurisdictions as $jurisdiction)
                                                            @if ($jurisdiction->name === 'England & Wales' && (!isset($companyFormationStep) || old('jurisdiction_id')))
                                                                <option value="{{ $jurisdiction->id }}" selected>
                                                                    {{ $jurisdiction->name }}</option>
                                                            @else
                                                                <option
                                                                    {{ old('jurisdiction_id') == $jurisdiction->id || (isset($companyFormationStep) && old('jurisdiction_id', $companyFormationStep->jurisdiction_id) == $jurisdiction->id) ? 'selected' : '' }}
                                            ...
                                            <input type="hidden" name="c_availablity" id="c_availablity"
                                                value="">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <select
                                                        class="form-select selected_sic @error('sic_code') is-invalid @enderror"
                                                        name="sic_code[]" id="multiple-select-field"
                ...
                .then(function(response) {
                    ...
                    if (response.data.message == 'This company name is available.') {
                        ...
                        if (companyName === response.data.items[0].title) {
                            ...
                            $('#paragraph').html(
                                `Name authorisation from <strong> ${response.data.items[0].title} </strong>`
                            );
                        }
                    }
                })
