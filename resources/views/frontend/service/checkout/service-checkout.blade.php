        ...
        <div class="woocommerce">
            ...
            <div class="package-steps text-center mb-4">
                <ol class="list-inline">
                    ...
                    <li class="list-inline-item">4.Service Checkout</li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                {{-- <ul class="list-group list-group-flush fa-ul ms-3">
                                        ...
                                        <li class="list-group-item px-0 py-2"><span class="fa-li"><i class="fa fa-caret-right"></i></span>feature</li>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="tax-rate tax-rate-vat-1">
                                                ...
                                                <td class="text-end"><span class="woocommerce-Price-amount amount vat">
                                                    <bdi>
                                                    <span class="woocommerce-Price-currencySymbol">£{{$service_transaction_details['vat']}}</span>
                                                    </bdi></span>
                                                </td>
                                            </tr>
                                                ...
                                                <td class="text-end" style="color:#40A800;">
                                                    <strong>
                                                        <span class="woocommerce-Price-amount amount">
                                                            <bdi><span class="woocommerce-Price-currencySymbol total-amount">£{{$service_transaction_details['total_amount']}}</span> </bdi>
                                                        </span>
                                                    </strong>
                                                </td>
                                            </tr>
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="reistration" role="tabpanel" aria-labelledby="nav-home-tab">
                            ...
                            @endif
                                ...
                                <div id="customer_details">
                                     <input type="hidden" readonly name="order" value="{{$service_transaction_details['total_amount']}}">
                                     <input type="hidden" name="order_id" id="service_order_id" value="{{$service_transaction_details['order_id']}}">
                                    @guest
                                    ...
                                    <fieldset class="border p-3 @if(Auth::check()) d-none @endif">
                                        ...
                                        <div class="woocommerce-billing-fields">
                                            <div class="woocommerce-billing-fields__field-wrapper row p-3">
                                                ...
                                                <input type="hidden" name="total_amount" id="all_total_amount" value="{{ $service_transaction_details['total_amount']}}">
                        ...
                        @guest
                            <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="login-tab">
                                <form action="{{ route('service_login_check') }}" method="POST" novalidate="novalidate">
                                    <input type="hidden" name="service_transaction_id" id="service_transaction_id" value="{{$service_transaction_details['id']}}">
