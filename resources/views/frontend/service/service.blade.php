                ...
                <div class="text-container">
                    ...
                    @if ($services->price != 0.0 && $services->price != '' && $services->price != '0')
                        <div class="action-btns">
                            <a href="{{ route('load_company_service', [$services->slug, $services->id]) }}"
                                class="theme-btn-primary buy-btn">
                                Buy Now
                            </a>
                        </div>
                    @endif
                        ...
                        <div class="digitalPackage-right-list-box floatTop">
                            ...
                            @if ($package_name == 'our-online-company-manager')
                                <div class="our-online-company-manager-col">
                                    <div class="our-online-company-manager-box" data-aos="fade-up" data-aos-delay="50"
                                        data-aos-duration="500" data-aos-once="true">
                                        <h3> Existing customers</h3>
                                        <p>Enter your username and password to access your Customer Dashboard.
                                        </p>
                                        <div class="action-btns">
                                            <a class="more-btn btn-primary" href="{{ route('clientlogin') }}">Click here to
                                                login</a>
                                        </div>
                                    </div>
                                    <div class="our-online-company-manager-box" data-aos="fade-up" data-aos-delay="50"
                                        data-aos-duration="500" data-aos-once="true">
                                        <h3> New customers</h3>
                                        <p>Fill in some basic information and you will be able to create an account and
                                            begin importing companies or forming new companies.</p>
                                        <div class="action-btns">
                                            <a class="more-btn btn-primary" href="{{ route('register-form') }}">Click here
                                                to create an account </a>
                                        </div>
                                    </div>
                                </div>
                            @else
                                @if ($services->how_it_works != null)
                                    <div class="digitalPackage-right-how_it_works-col" data-aos="fade-up"
                            ...
                            <div class="digitalPackage-right-list-col" data-aos="fade-up" data-aos-delay="50"
                                data-aos-duration="500" data-aos-once="true">
                                    ...
                                    <ul class="list-info">
                                        @if ($package_name != 'barclays-bank-account')
                                            <li>
                                                ...
                                                <p>
                                                    <a href="{{ route('company_services', ['barclays-bank-account']) }}">Barclays
                                                        Bank Account</a>
                                                </p>
                                        ...
                                        @if ($package_name != 'cashplus-business-account')
                                            <li>
                                                ...
                                                <p>
                                                    <a
                                                        href="{{ route('company_services', ['cashplus-business-account']) }}">Cashplus
                                                        Business Account</a>
                                                </p>
                                            </li>
                                        @endif
                                        @if ($package_name != 'wise-business-account-for-non-uk-residents')
                                            <li>
                                                ...
                                                <p>
                                                    <a
                                                        href="{{ route('company_services', ['wise-business-account-for-non-uk-residents']) }}">Wise
                                                        Business Account</a>
                                                </p>
                                            </li>
                                        @endif
                                        @if ($package_name != 'payoneer-business-account-for-non-uk-residents')
                                            <li>
                                                ...
                                                <p>
                                                    <a
                                                        href="{{ route('company_services', ['payoneer-business-account-for-non-uk-residents']) }}">Payoneer
                                                        Business Account</a>
                                                </p>
                                            </li>
                                        @endif
                                        @if ($package_name != 'card-one-business-account')
                                            <li>
                                                ...
                                                <p> <a
                                                        href="{{ route('company_services', ['card-one-business-account']) }}">Card
                                                        One Business Account</a> </p>
                                            </li>
                                        @endif
            ...
            <div class="custom-container">
                <div class="sec-title1 text-center">
                    <h2 data-aos="fade-up" data-aos-delay="50" data-aos-duration="500" data-aos-once="true"
                        class="aos-init aos-animate">Frequently Asked <span>Questions</span></h2>
                </div>
                        ...
                        <div class="card" data-aos="fade-up" data-aos-delay="50" data-aos-duration="500"
                            ...
                            <div class="card-header" id="headingOne{{ $faq->id }}">
                                <button class="btn btn-link collapsed" data-toggle="collapse"
                                    data-target="#collapseOne{{ $faq->id }}" aria-expanded="false"
                            ...
                            <div id="collapseOne{{ $faq->id }}" class="collapse"
                                aria-labelledby="headingOne{{ $faq->id }}" data-parent="#accordion">
                                <div class="card-body">
                                    <p>{{ $faq->answer }}</p>
                                </div>
                            </div>
