                            ...
                            <section id="steps-uid-0-p-0" role="tabpanel" aria-labelledby="steps-uid-0-h-0"
                                ...
                                <hr>
                                    ...
                                    <div class="col-md-8 p-3 d-block mb-3 position-relative shadow">
                                        ...
                                        <div class="mb-3 row">
                                            <label for="no_of_officer" class="col-sm-4 col-form-label">Number of officers<br>(directors/shareholders/PSC’s)</label>
                                            <div class="col-sm-6">
                                                <select class="form-control hasprice" aria-label="Default select example" name="no_of_officer" id="no_of_officer">
...
<script>
    ...
    $("document").ready(function() {
        ...
        var sum =  parseFloat({{ $prices['directors_service_address_price'] }});
        var coi =  parseFloat({{ $prices['registered_address'] }});
