            ...
            <tr>
                ...
                <td style="font-size: 14px;color: #000;vertical-align: top;">
                    <div style="display: table;margin: 0 0 0 auto;">
                        ...
                        <p>Invoice Date:
                            {{ $transaction ? \Carbon\Carbon::parse($transaction->created_at)->format('d/m/Y') : '' }}
                        </p>
                    </div>
                </td>
            </tr>
                        ...
                        <tr>
                            <td style="padding: 0;">
                                <table width="100%" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td colspan="6"
                                            style="background:#cdc9c9;padding: 10px;border: 1px solid #000;">
                                            <strong>{{ $deliveryPartner->companie_name ?? '' }}</strong>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td
                                            style="background:#eee9e9;padding: 10px; border-left: 1px solid #000; border-right: 1px solid #000; border-bottom: 1px solid #000;">
                                            <strong><i>Product</i></strong>
                                        </td>
                                        <td
                                            style="background:#eee9e9;padding: 10px;border-right: 1px solid #000;border-bottom: 1px solid #000; text-align: right;">
                                            <strong><i>Quantity</i></strong>
                                        </td>
                                        <td
                                            style="background:#eee9e9;padding: 10px;border-right: 1px solid #000;border-bottom: 1px solid #000; text-align: right;">
                                            <strong><i>Unit Price</i></strong>
                                        </td>
                                        <td
                                            style="background:#eee9e9;padding: 10px;border-right: 1px solid #000;border-bottom: 1px solid #000; text-align: right;">
                                            <strong><i>Net</i></strong>
                                        </td>
                                        <td
                                            style="background:#eee9e9;padding: 10px;border-right: 1px solid #000;border-bottom: 1px solid #000; text-align: right;">
                                            <strong><i>VAT</i></strong>
                                        </td>
                                        <td
                                            style="background:#eee9e9;padding: 10px;border-right: 1px solid #000;border-bottom: 1px solid #000; text-align: right;">
                                            <strong><i>Gross</i></strong>
                                        </td>
                                    </tr>

                                    <tr>
                                        <td
                                            style="padding: 4px 10px;border-left: 1px solid #000;border-right: 1px solid #000;">
                                        ...
                                        <td style="padding: 4px 10px;text-align: right;border-right: 1px solid #000;">
                                            <strong>£{{ $all_order->cart->package->package_price + ($all_order->cart->package->package_price * 20) / 100 }}
                                            </strong>
                                        </td>
                                    </tr>
                                    ...
                                    @foreach ($all_order->cart->addonCartServices as $item)
                                        ...
                                        <tr>
                                            <td
                                                style="padding: 4px 10px;border-left: 1px solid #000;border-right: 1px solid #000;font-size:14px;color:#646464;">
                                                {{ $item->service->service_name }}</td>
                                            <td
                                                style="padding: 4px 10px;text-align: right;border-right: 1px solid #000;font-size:14px;color:#646464;">
                                                1</td>
                                            <!-- <td><span class="status accepted">Accepted</span></td> -->
                                            <td
                                                style="padding: 4px 10px;text-align: right;border-right: 1px solid #000;font-size:14px;color:#646464;">
                                                £{{ $item->service->price }}</td>
                                            <td
                                                style="padding: 4px 10px;text-align: right;border-right: 1px solid #000;font-size:14px;color:#646464;">
                                                £{{ $item->service->price }}</td>
                                            <td
                                    ...
                                    <!-- total section -->
                                    <tr>
                                        <td style="padding: 4px 10px;font-size:14px;border-top: 1px solid #000;">
                                            <strong></strong>
                                        </td>
                                        <td
                                            style="padding: 4px 10px;text-align: right;font-size:14px;border-top: 1px solid #000;">
                                            <strong></strong>
                                        </td>
                                        <td
                                            style="padding: 10px 10px;text-align: right;border-right: 1px solid #000;font-size:14px;border-top: 1px solid #000;">
