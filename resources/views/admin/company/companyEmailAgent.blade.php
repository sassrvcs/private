            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Send Email To Agent</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                    ...
                    <div class="card card-primary">
                        <div class="card-body">
                            <form action="{{ route('admin.company.sent_email_user') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <x-Forms.Input type="email" mandate="*" label="Agent Email" id="name"
                                            name="email" value=""
                                    ...
                                    <div class="col-sm-3">
                                        <x-Forms.Input type="text" mandate="*" label="Agent Name" id=""
