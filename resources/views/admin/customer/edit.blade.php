                    ...
                    <div class="card card-primary">
                        <div class="card-body">
                            <form action="{{ route('admin.customer.update', $customerDetails->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <x-Forms.Input type="text" name="house_number" id="house_number" mandate="*" label="House Name/Number" value="{{ $customerDetails['address']->house_number }}" class="form-control {{ $errors->has('house_number') ? 'is-invalid' : '' }}"  />
                                    </div>

                                    <div class="col-sm-4">
                                        <x-Forms.Input type="text" name="street" id="street" mandate="*" label="Street" value="{{ $customerDetails['address']->street }}" class="form-control {{ $errors->has('street') ? 'is-invalid' : '' }}"  />
                                    </div>

                                    <div class="col-sm-4">
                                        <x-Forms.Input type="text" name="locality" id="locality" label="Locality" value="{{ $customerDetails['address']->locality }}"/>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <x-Forms.Input type="text" name="town" id="town" mandate="*" label="Town " value="{{ $customerDetails['address']->town }}" class="form-control {{ $errors->has('town') ? 'is-invalid' : '' }}"  />
                                    </div>

                                    <div class="col-sm-4">
                                        <x-Forms.Input type="text" name="country" id="country" label="Country" value="{{ $customerDetails['address']->country }}"/>
                                    </div>

                                    <div class="col-sm-4">
                                        <x-Forms.Input type="text" name="postcode" id="postcode" mandate="*" label="Postcode" value="{{ $customerDetails['address']->post_code }}" class="form-control {{ $errors->has('postcode') ? 'is-invalid' : '' }}"/>
                                    </div>
