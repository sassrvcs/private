...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Accounting Software List</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                    <li class="breadcrumb-item active">Accounting Software List</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
                        ...
                        <form action="">
                            ...
                            <input type="text" value="{{ $search }}" name="search" placeholder="Find by email or name" id="search" class="form-control form-control-sm" required>
                                ...
                                <div class="input-group-append">
                                    ...
                                    <a href="{{ route('admin.accounting.index') }}" class="btn btn-sm btn_baseColor" id="clear-search" type="button">Clear &nbsp;</a>
                                </div>
                            </div>
                        </form>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <a href="javascript:{}" class="delete-user" data-id={{ $accounting->id }}  data-user="Accounting "
                                                            data-route="{{ route('admin.accounting.destroy', $accounting->id) }}" style="color: #f30031">
                        ...
                        <div class="card-footer">
                            <nav aria-label="Contacts Page Navigation" class="pagenation-agent">
                               {{-- {{ $users->appends([
                                ...
                                {!! $accountinglist->withQueryString()->links() !!}
                            </nav>
                        </div>
                    {{-- @endif --}}
                    <!-- /Card Footer -->
