...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Expired Service List</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item active">Expired Service List</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                    ...
                    <div class="card pdb-75">
                            ...
                            <form action="" id="searchForm">
                                <div class="input-group w-50 float-right">
                                    ...
                                    <div class="input-group-append">
                                        ...
                                        <a href="{{ route('admin.expired-service-list-admin') }}" class="btn btn-sm btn_baseColor"
                        ...
                        <div class="card-footer">
                            <nav aria-label="Contacts Page Navigation" class="pagenation-agent">
                                ...
                                {!! $expired_service->withQueryString()->links() !!}
                            </nav>
                        </div>
                        {{-- @endif --}}
                        <!-- /Card Footer -->
